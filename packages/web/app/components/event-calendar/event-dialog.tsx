...
import {
	...
	EndHour,
	StartHour
} from '~/components/event-calendar/constants.ts'
...
import { RadioGroup, RadioGroupItem } from '~/components/shadcn/ui/radio-group.tsx'
import {
	Select,
	SelectContent,
	SelectItem,
...
export function EventDialog({ event, isOpen, onClose, onSave, onDelete }: EventDialogProps) {
	...
	useEffect(() => {
		if (event) {
			...
			setError(undefined) // Reset error when opening dialog
		} else {
			resetForm()
		}
			...
			<DialogContent className='sm:max-w-[425px]'>
				...
				<div className='grid gap-4 py-4'>
					...
					<fieldset className='space-y-4'>
						<legend className='text-sm leading-none font-medium text-foreground'>Etiquette</legend>
						<RadioGroup
